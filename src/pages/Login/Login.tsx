    ...
    return (
        <div className="flex h-screen bg-gray-100 items-center justify-center">
            <div className="flex flex-col items-center bg-white w-[400px] p-8 rounded-lg shadow-lg">
                ...
                <button className="w-full p-3 bg-orange-500 text-white rounded hover:bg-orange-600">Đăng nhập</button>
                <div className="flex items-center w-full my-6">
                    <div className="flex-grow border-t border-gray-300"></div>
                    <span className="text-[14px] mx-4 text-gray-500 font-semibold uppercase">Hoặc</span>
                    <div className="flex-grow border-t border-gray-300"></div>
                </div>
                <button className="p-3 flex items-center justify-center border rounded-full hover:bg-gray-100">
