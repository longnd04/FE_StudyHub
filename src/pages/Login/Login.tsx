            ...
            <div className="flex flex-col items-center bg-white w-[500px] p-10 rounded-xl gap-6 shadow-md">
                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="flex flex-col">
                        ...
                        <input type="text" id="username" className="border p-2 focus:border-orange-200 focus:outline-none rounded" required />
                    </div>
                    <div className="flex flex-col">
                        <label htmlFor="password">Mật khẩu</label>
                        <input type="password" id="password" className="border p-2 focus:border-orange-200 focus:outline-none rounded" required />
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3 mt-4 text-center cursor-pointer font-medium">
                    <FcGoogle className="text-2xl" />
                    <div className="flex text-center">Đăng nhập với Google</div>
                </div>
                <div className="text-center mt-4">
                    <div>Bạn chưa có tài khoản? <span className="text-orange-500 underline cursor-pointer">Đăng ký</span></div>
