            ...
            <div>
                <Row className="bg-white flex p-10 w-full gap-10 rounded-lg shadow-lg relative">
                    <Col className="relative">
                        ...
                        <div className="w-[30px] h-[30px] bg-blue-300 absolute right-0 rounded-full top-[103px] cursor-pointer flex justify-center items-center"> <BsPencil size={18} /></div>
                    </Col>
                    ...
                    <Button className="absolute right-10 bottom-5 " text="Cập nhật"></Button>
                </Row>
            </div>
        </div>
    )
